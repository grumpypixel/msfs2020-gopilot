...
echo "Building..."
CGO_ENABLED=1 GOOS=windows GOARCH=amd64 go build -o $EXEC gopilot/main.go gopilot/request_manager.go gopilot/assetspack.go gopilot/datapack.go gopilot/dllpack.go
echo "Done."
